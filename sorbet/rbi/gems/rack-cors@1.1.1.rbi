...
# source://rack-cors-1.1.1/lib/rack/cors.rb:3
module Rack
  class << self
...
# source://rack-cors-1.1.1/lib/rack/cors.rb:4
class Rack::Cors
  # @return [Cors] a new instance of Cors
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:28
  def initialize(app, opts = T.unsafe(nil), &block); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:54
  def allow(&block); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:64
  def call(env); end

  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:50
  def debug?; end

  protected

  # source://rack-cors-1.1.1/lib/rack/cors.rb:169
  def all_resources; end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:134
  def debug(env, message = T.unsafe(nil), &block); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:155
  def evaluate_path(env); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:207
  def match_resource(path, env); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:185
  def process_cors(env, path); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:173
  def process_preflight(env, path); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:198
  def resource_for_path(path_info); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:138
...
class Rack::Cors::Resource
  ...
  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:377
  def match?(path, env); end

  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:373
  ...
  # source://rack-cors-1.1.1/lib/rack/cors.rb:381
  def process_preflight(env, result); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:401
  ...
  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:429
  def allow_headers?(request_headers); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:446
  def compile(path); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:441
  def ensure_enum(v); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:416
  def origin_for_response_header(origin); end

  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:412
  def public_resource?; end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:421
  def to_preflight_headers(env); end
end

# source://rack-cors-1.1.1/lib/rack/cors.rb:337
class Rack::Cors::Resource::CorsMisconfigurationError < ::StandardError
  # source://rack-cors-1.1.1/lib/rack/cors.rb:338
  def message; end
end

# source://rack-cors-1.1.1/lib/rack/cors.rb:282
class Rack::Cors::Resources
  # @return [Resources] a new instance of Resources
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:286
  def initialize; end

  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:314
  def allow_origin?(source, env = T.unsafe(nil)); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:326
  def match_resource(path, env); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:292
  def origins(*args, &blk); end

  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:310
  def public_resources?; end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:306
  def resource(path, opts = T.unsafe(nil)); end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:330
  def resource_for_path(path); end

  # Returns the value of attribute resources.
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:284
  def resources; end
end

# source://rack-cors-1.1.1/lib/rack/cors.rb:223
class Rack::Cors::Result
  # source://rack-cors-1.1.1/lib/rack/cors.rb:270
  def append_header(headers); end

  # Returns the value of attribute hit.
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:233
  def hit; end
  ...
  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:235
  def hit?; end

  # source://rack-cors-1.1.1/lib/rack/cors.rb:243
  def miss(reason); end
  ...
  # @return [Boolean]
  #
  # source://rack-cors-1.1.1/lib/rack/cors.rb:239
  def preflight?; end

  class << self
    # source://rack-cors-1.1.1/lib/rack/cors.rb:248
    def hit(env); end

    # source://rack-cors-1.1.1/lib/rack/cors.rb:255
    def miss(env, reason); end

    # source://rack-cors-1.1.1/lib/rack/cors.rb:263
    def preflight(env); end
  end
end

# source://rack-cors-1.1.1/lib/rack/cors.rb:224
Rack::Cors::Result::HEADER_KEY = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:231
Rack::Cors::Result::MISS_DENY_HEADER = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:230
Rack::Cors::Result::MISS_DENY_METHOD = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:229
Rack::Cors::Result::MISS_NO_METHOD = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:226
Rack::Cors::Result::MISS_NO_ORIGIN = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:227
Rack::Cors::Result::MISS_NO_PATH = T.let(T.unsafe(nil), String)

# source://rack-cors-1.1.1/lib/rack/cors.rb:20
